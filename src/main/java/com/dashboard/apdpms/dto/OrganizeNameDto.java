...
public class OrganizeNameDto {
	 ...
	 private String dname;
	    ...
	    public OrganizeNameDto() {
			// TODO Auto-generated constructor stub
		}

		public OrganizeNameDto(String dname, String orgName, Float bpapproved, Float bpsitearea, Float bpbua,
				Float bpgreenfeelabour, Float bpamtcollected, Float bptotalamt, Float layoutapproved,
				Float layoutsitearea, Float layoutamt, Float occupancyapproved, Float occupancygreenfee,
				Float occupancyamtcollected) {
			super();
			this.dname = dname;
		...
		public Float getBpapproved() {
			return bpapproved;
		}

		public void setBpapproved(Float bpapproved) {
			this.bpapproved = bpapproved;
		}
		...
		public Float getLayoutapproved() {
			return layoutapproved;
		}

		public void setLayoutapproved(Float layoutapproved) {
			this.layoutapproved = layoutapproved;
		}
		...
		public Float getOccupancyapproved() {
			return occupancyapproved;
		}

		public void setOccupancyapproved(Float occupancyapproved) {
			this.occupancyapproved = occupancyapproved;
		}
