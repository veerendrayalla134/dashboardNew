...
public class ApdpmSystemDistrictName {
	  ...
	  private String dname;
	    ...
	    // Constructors
public ApdpmSystemDistrictName() {
	// TODO Auto-generated constructor stub
}
	  

	    public ApdpmSystemDistrictName(String dname, Double bpapproved, Double bpsitearea, Double bpbua,
				Double bpgreenfeelabour, Double bpamtcollected, Double bptotalamt, Double layoutapproved,
				Double layoutsitearea, Double layoutamt, Double occupancyapproved, Double occupancygreenfee,
				Double occupancyamtcollected) {
			super();
			this.dname = dname;
